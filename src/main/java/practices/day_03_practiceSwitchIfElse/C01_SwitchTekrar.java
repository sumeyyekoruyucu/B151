package practices.day_03_practiceSwitchIfElse;

import java.util.Scanner;

public class C01_SwitchTekrar {
     /*
     ...
     public static void main(String[] args) {
         ...
         System.out.println("Lutfen sinav puaninizi 0-4 arasinda giriniz");

         double puan= input.nextDouble();
         String seviye="";

         if (puan>=0.0 && puan<1.0){
             seviye="KALDI";
         }else if (puan>=1.0 && puan<2.0){
             seviye="GECTI";
         }else if (puan>=2.0 && puan<2.5){
             seviye="IYI";
