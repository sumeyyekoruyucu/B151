...
public class PassByValue01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(shirtPrice); //200 (java nin orjinali korumasina passbyvalue denilir)

    }

    //method olusturcaz main method disina
    // Discount Method'u olusturunuz// discount:indirim yapmak ,aksiyon
