...
public enum UsStatesEnum {
    //Enum lar degisme ihtimali olmayan datalari depolamak icin kullanilir.  Or:Gun isimleri,
    // ay isimleri;Eyalet isimleri vb.
    /*
    ...
    private final String stateName;//sadece bu enumda kullanilacagi icin private,degismeyecegi icin final
    ...
    //state'in ismini  verince State kisaltmasini veren method
