...
public class C02_WrapperClass {
    ...
    public static void main(String[] args) {
        ...
        //Ex : int data type`inin max degeri ile byte data type`inin
       ...
       //**************** Primitive Data Type'larini Wrapper Classlara Nasil Ceviririz ********************
        ...
        String harf ="A";
        int Sayi= 7;
        //harf+sayi ==> A7  +yanina yazdirir komplesi string olur.
        // nonprimitive primitive i yutar
        /*

       8+3+"K"

       "K" + 3*5/2;   ne yazdirir bakalim // K7   K7.5   K4
        ...
        String a="K";
        int b=3, c=5 , d=2;
        System.out.println(a+b*c/d);//K7 OLUR double yaparsak K7.5 olur
